...
*  - $page['herp']: Items for the hero region.
 * - $page['content']: The main content of the current page.
 * - $page['sidebar_first']: Items for the first sidebar.
 * - $page['sidebar_second']: Items for the second sidebar.
 * - $page['header']: Items for the header region.
 * - $page['footer']: Items for the footer region.
 * - $page[preface_first]    = 'Preface first'
* -  $page[preface_middle]    = 'Preface middle'
* -  $page[footer_last]    = 'footer last'
 * - $page[footer_first]    = 'footer first'
* -  $page[footer_middle]    = 'footer middle'
* -  $page[footer_last]    = 'footer last'
 *
...
<div class="main-container container-fluid">
  ...
  <div class="row">
    <section class="preface-region">
      ...
      <?php endif; ?>
      <?php if (!empty($page['preface_middle'])): ?>
        <div class="col-md-4">
          <div class="preface">
      ...
      <?php endif; ?>
      <?php if (!empty($page['preface_last'])): ?>
        <div class="col-md-4">
          <div class="preface">
